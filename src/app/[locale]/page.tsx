        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8" style={{ 
              ...
              <span style={{ color: 'var(--red)' }} className="text-sm font-semibold">Trusted by 1000+ guests in Kuwait</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight" style={{ 
              ...
              Book verified homes<br />with transparent pricing
            </h1>

            {/* Subtext */}
            <p className="text-lg sm:text-xl lg:text-2xl mb-10 max-w-2xl mx-auto leading-relaxed" style={{ color: '#222222' }}>
              No hidden fees. Clear guest limits. Instant confirmation.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl max-w-2xl mx-auto" style={{ color: 'var(--text-muted)' }}>
              We make booking accommodations in Kuwait simple, secure, and trustworthy.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-dark)' }}>Verified Properties</h3>
              <p style={{ color: 'var(--text-muted)' }}>
                All properties undergo thorough KYC verification for your safety and peace of mind.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-dark)' }}>Transparent Pricing</h3>
              <p style={{ color: 'var(--text-muted)' }}>
                No hidden fees. All prices in KWD with clear breakdown of costs before booking.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-dark)' }}>Arabic Support</h3>
              <p style={{ color: 'var(--text-muted)' }}>
                Full Arabic and English support with RTL design for seamless browsing.
              </p>
            </div>
          </div>
        </div>
